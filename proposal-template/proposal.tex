...
\newcommand{\projectTitle}{Filament-Verwaltung}
...
I'd like to build an app that lets me manage the filament for my 3D printer. I have a lot of different spools of filament and am slowly losing track of how much of each color, material, and manufacturer I have. I'll be the main user of this software. 
The app should allow me to add all my existing filament spools and their current weights, as well as suggest a suitable spool for new prints—so that the lightest spool with enough filament on it is selected.
